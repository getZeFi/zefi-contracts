...
//contract YDaiMock {
//  IERC20 token;
//  mapping(address => uint) public balances; //balance of ytoken
//
...
//    balances[msg.sender] -= (shares * 100) / 110;
//  }
//
//  function getPricePerFullShare() public view returns(uint) {
//    return (110 * 1 ether) / 100; //this is 1.1 * 10^18
//  }
//
...
contract YDaiMock is ERC20, ERC20Detailed, ReentrancyGuard, Structs, Ownable {
  ...
  function calcPoolValueInToken2() public view returns (uint) {
    return totalSupply();
    //return balanceCompoundInToken()
    //  .add(balanceFulcrumInToken())
    //  .add(balanceDydx())
